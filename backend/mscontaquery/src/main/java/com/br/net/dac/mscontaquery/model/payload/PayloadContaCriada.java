package com.br.net.dac.mscontaquery.model.payload;

import java.sql.Date;

public class PayloadContaCriada {
    ...
    public PayloadContaCriada() {}

    public PayloadContaCriada(String numero, String gerenteCpf, String clienteCpf, Date data, Double saldo,
